...
export default function VoteBanner() {
  return (
    <a
      ...
      className="card-surface fixed bottom-4 left-4 z-40 flex items-center gap-2 rounded-none border-gold px-3 py-2 text-xs font-semibold text-gold shadow-lg transition hover:border-accent-2/40 hover:text-foreground"
    >
