  ...
  A: {
    heavy: [
      ...
      },
      {
        ...
        bonuses: [
          "Requisito: Baron o Aristocrat de nivel superior",
          "Pieza única: ocupa upper y lower body",
          "P. Def. de la pieza: 303",
          "Max CP +1350",
          "Velocidad de recuperación de CP +30%",
          "P. Atk. +5%",
          "P. Def. +5%",
          "Velocidad +6",
          "Refleja 3% de los debuffs al atacante",
          "STR +1",
          "CON +1",
          "Incluye escudo — daño recibido de skills en PvP -3% con el set Apella Heavy equipado",
          "Con 6 o más de encantamiento en todo el set: sube P. Atk., P. Def. y regeneración de MP.",
        ],
      },
    ],
    ...
    robe: [
      ...
      },
      {
        ...
        bonuses: [
          ...
          "Pieza única: ocupa upper y lower body",
          "Aumento de MP: 0",
          "P. Def. de la pieza: 158",
          "Max CP +920",
          "Velocidad de recuperación de CP +30%",
          "Vel. de casteo +12%",
          "P. Def. +8%",
          "Resistencia a ataques mentales +10%",
          "Resistencia a dagas +10%",
          "WIT +1",
          "MEN +1",
          "Con 6 o más de encantamiento en todo el set: sube P. Def., Vel. de casteo y resistencia a dagas.",
        ],
